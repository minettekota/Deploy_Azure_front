...
export default function Home() {
  ...
  const handleIdRequest = async (e) => {
    ...
    const res = await fetch(`tech0-gen-8-step3-testappy-py-28.azurewebsites.net/api/multiply/${id}`, {
      method: 'GET',
    });
    const data = await res.json();
  ...
  const handleSubmit = async (e) => {
    ...
    const res = await fetch('tech0-gen-8-step3-testappy-py-28.azurewebsites.net/api/echo', {
      method: 'POST',
      headers: {
